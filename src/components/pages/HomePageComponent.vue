<template>
  <div class="">
    <div
      class="top-0 sm:my-12 flex sm:flex-row flex-col items-center justify-center m-auto gap-4"
    >
      <div class="p-4">
        <h1
          class="break-word font-bold text-xl sm:text-4xl text-neutral-700 [text-shadow:_0_0px_20px_rgb(256_256_256_/_100%)]"
        >
          Інтернет-магазин
          <br /><span class="sm:text-6xl text-2xl font-black text-emerald-700"
      ...
      <div class="relative">
        <img
          class="sm:m-4 p-4 sm:p-0 sm:h-72 relative rounded-3xl hover:-translate-y-3 hover:rotate-2 cursor-pointer duration-300"
    ...
    >
      ...
      >
        ...
        <div class="flex flex-col text-neutral-700">
          <div
            class="backdrop-filter backdrop-blur-xl group cursor-pointer sm:absolute m-2 sm:m-0 left-0 sm:ml-56 routerlink"
          >
            <router-link
          ...
          <router-link
            ...
            class="duration-300 hover:text-neutral-500 break-word font-bold m-2 sm:m-0 text-2xl sm:text-4xl text-neutral-700"
          >
            {{ product.name }}
          </router-link>
          ...
          >
            <div
              class="py-4 my-4 m-2 sm:m-0 justify-center gap-4 group routerlink flex flex-row items-center cursor-pointer"
            >
    ...
    <div
      class="flex mb-32 px-4 sm:px-0 gap-4 mt-4 sm:text-3xl m-auto sm:w-2/3 flex-row"
    >
